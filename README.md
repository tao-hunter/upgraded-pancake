...
**New in v2.1:** Automatic color calibration, lighting normalization, and view validation!

See `QUALITY_IMPROVEMENTS.md` and `QUICK_WINS_IMPLEMENTED.md` for detailed explanations
